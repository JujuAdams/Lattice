...
if (not variable_instance_exists(id, "group"))
{
    show_error(".group must be defined", true);
}

if (not variable_instance_exists(id, "index"))
{
    show_error(".index must be defined", true);
}
