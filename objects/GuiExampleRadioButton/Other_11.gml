...
if (RadioButtonGet(group) == index)
{
    LatDrawSprite(sFontFull, 15, x+1, y, C_LEMON);
}

LatDrawSprite(sFontFull, 40, x,   y, _arrowColor);
LatDrawSprite(sFontFull, 41, x+2, y, _arrowColor);
