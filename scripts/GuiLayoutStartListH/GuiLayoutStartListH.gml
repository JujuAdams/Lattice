...
function GuiLayoutStartListH(_parent, _spacing, _hAlign, _vAlign)
{
    var _layout = new __GuiClassLayoutListH(_parent, _spacing, _hAlign, _vAlign);
    return _layout;
}

function __GuiClassLayoutListH(_parent, _spacing, _hAlign, _vAlign) constructor
{
    __parent  = _parent;
    __spacing = _spacing;
    __hAlign  = _hAlign;
