...
// What room layer to create instances on when using `GuiCreate()`. Use `undefined` to instead
// create instances using a particular depth see `GUI_CREATE_DEPTH`.
#macro GUI_CREATE_LAYER  undefined

// What depth to create instances on when using `GuiCreate()`. This macro will only be used if
